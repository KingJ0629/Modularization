...
public class UamaRefreshLayout extends ViewGroup {
    ...
    private static final String TAG = "UamaRefreshLayout";
    private int mStatus;
    ...
    private List<OnVRefreshListener> mOnRefreshListeners;
    private UpdateHandler mUpdateHandler;
    private UamaRefreshDefaultHeaderView mUamaRefreshUamaRefreshDefaultHeaderView;

    public UamaRefreshLayout(Context context) {
        this(context, null);
    }

    public UamaRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public boolean getUamaRefreshUamaRefreshDefaultHeaderView() {
        return mHeaderView == mUamaRefreshUamaRefreshDefaultHeaderView;
    }

    public View getDefaultHeaderView() {
        if (mUamaRefreshUamaRefreshDefaultHeaderView == null) {
            setDefaultHeaderView();
        }
        return mUamaRefreshUamaRefreshDefaultHeaderView;
    }

    private void setDefaultHeaderView() {
        mUamaRefreshUamaRefreshDefaultHeaderView = new UamaRefreshDefaultHeaderView(getContext());
        mUamaRefreshUamaRefreshDefaultHeaderView.setPadding(0, dp2px(10), 0, dp2px(10));
        mUamaRefreshUamaRefreshDefaultHeaderView.setLayoutParams(new ViewGroup.LayoutParams(LayoutParams.MATCH_PARENT, dp2px(64)));
        setHeaderView(mUamaRefreshUamaRefreshDefaultHeaderView);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mHeaderView != null) {
            ...
            if (mIsInitMeasure) {
                ...
                mHeaderOriginTop = mHeaderCurrentTop = -measuredHeight;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //layout contentView
        if (mContentView != null) {
            int distance = mHeaderCurrentTop - mHeaderOriginTop;
    ...
    private void animOffsetAutoRefresh() {
        ...
        int to = mMaxDragDistance + mHeaderOriginTop;
    ...
    private void actionMoving(float y) {
        ...
        if (y <= mMaxDragDistance) {
            int targetY = (int) (mHeaderOriginTop + y);
            moveTo(targetY);
        }
    }
    ...
    private void moveTo(int y) {
        ...
        mHeaderCurrentTop = mHeaderView.getTop();
        mProgress.currentY = mHeaderCurrentTop - mHeaderOriginTop;
        notifyProgress();
    }
    ...
    public void addOnVRefreshListener(OnVRefreshListener onRefreshListener) {
    ...
    private void notifyRefreshListeners() {
        ...
        for (OnVRefreshListener onRefreshListener : mOnRefreshListeners) {
    ...
    public interface OnVRefreshListener {
        void onRefresh();
    }


    public interface UpdateHandler {
        void onProgressUpdate(UamaRefreshLayout layout, Progress progress, int status);
    }
